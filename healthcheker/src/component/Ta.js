    ...
    return(
        <ChakraProvider>
            ...
            <link href="https://fonts.googleapis.com/css2?family=Itim&display=swap" rel="stylesheet" />
                <Box display="flex">
                <Box w="100%" mt="3%">
                <Text fontSize="7xl" fontFamily="'Itim', cursive">แบบทดสอบ</Text>
                <Text fontSize="6xl" fontFamily="'Itim', cursive">ภาวะซึมเศร้า PHQ-9</Text>
                </Box>
                <Box w="80%" mt="-15%" mr="0%" ml="0%">
                    <img src="./images/depress.png.png"/>
                </Box>
                </Box>
                <Box>
